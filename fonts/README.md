...
That slot falls back to Pixelify Sans and the title screen says so along the
...
Pixelify Sans is exempt because it is embedded as a data URI directly in
...
committing the file *is* redistribution. Pixelify Sans is here under the SIL
